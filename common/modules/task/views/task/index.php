                    ...
                    'template' => '{update} {finished}',   
                        'buttons'=>[  
                            'update'=>function ($url, $model) {
                                return Html::a('<span class="glyphicon glyphicon-edit"></span>', ['update', 'id'=>$model['id'],'action_id' => 'index'], ['class' => 'btn btn-link','title' => 'Edit']);
                            },
                             'finished'=>function ($url, $model) {
                                return Html::a('<span class="glyphicon glyphicon-ok"></span>', ['is-active', 'id'=>$model['id'], 'action_id' => 'index'], ['class' => 'btn btn-link','title' => 'Mark as Finished']);
                            },
                        ],
                ],
            ],
