                ...
                'template' => '{update} {finished}',   
                    'buttons'=>[  
                        'update'=>function ($url, $model) {
                            return Html::a('<span class="glyphicon glyphicon-edit"></span>', ['update', 'id'=>$model['id'],'action_id' => 'finished-task'], ['class' => 'btn btn-link','title' => 'Edit']);
                        },
                         'finished'=>function ($url, $model) {
                            return Html::a('<span class="glyphicon glyphicon-share-alt"></span>', ['is-active', 'id'=>$model['id'], 'action_id' => 'finished-task'], ['class' => 'btn btn-link','title' => 'Retore to Task']);
                        },
                    ],
            ],
        ],
